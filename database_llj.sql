...
-- updating the llj_id based on jurisdiction_id, gis_lati, gis_longi
...
-- updating the rest llj_id based on jurisdiction_id, select a random 
update public.allpolicy a 
set llj_id = (
 select lj.llj_id 
...
-- updating the rest llj_id based on gis_lati, gis_longi, select a random of the already assigned
update public.allpolicy a
set llj_id = (
 select aa.llj_id 
 from allpolicy aa
...
-- updating the rest llj_id based on re_community, select a random of the already assigned, 
update public.allpolicy a
set llj_id = (
 select pp.llj_id 
...
exists(
 ...
 -- updating the rest llj_id based on re_state, select a random of the already assigned, 
update public.allpolicy a
set llj_id = (
 select aa.llj_id 
 from public.allpolicy aa
...
---------------------------------------------------------------------------------------------------------------------------------------- 
-- adding llj_id to claims data, 1625472
alter table public.paidclaims add column llj_id integer;
-- updating the llj_id based on jurisdiction_id, gis_lati, gis_longi, 1508065
...
-- updating the rest llj_id based on jurisdiction_id, select a random, 115685
update public.paidclaims p
set llj_id = (
 select lj.llj_id 
 from fima.llj lj
...
-- updating the rest llj_id based on gis_lati, gis_longi, select a random of the already assigned, 1554
update public.paidclaims p
set llj_id = (
 select pp.llj_id 
